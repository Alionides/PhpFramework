...
#  Php Framework Symfony ve Laravel 



## Authors

- [Ali Shikhiyev](https://github.com/Alionides)



## Php kitabxanalar (packages)
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        <div class="space-y-2 py-6">
                            {% for m in menu %}
                                <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">{{ m }}</a>
                            {% endfor %}
                        </div>
                        <div class="py-6">
